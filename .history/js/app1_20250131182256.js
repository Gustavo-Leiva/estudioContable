    ...
    fetch("../js/articulos.json")
        ...
        .then(data => {
            ...
            data.forEach(articulo => {
                ...
                // Insertar el contenido de cada artículo dentro de la tarjeta sin los comentarios incorrectos
                card.innerHTML = `
                    ...
                    <img src="${articulo.imagen}" alt="Imagen del artículo" class="article-image"/>  <!-- Imagen del artículo -->
                `;
