    ...
    fetch("../js/articulos.json")
        ...
        .then(data => {
            ...
            data.forEach(articulo => {
                ...
                // Reemplazar saltos de línea en el contenido
                const contenidoConSaltos = articulo.contenido.replace(/\n/g, '<br>');
                ...
                let cardContent = `
                    ...
                    <div class="card-body">
                        ...
                        <p class="full-content" style="display: none;">${contenidoConSaltos}</p>  <!-- Contenido completo (oculto inicialmente) -->
                    </div>
