    ...
    fetch("../js/articulos.json")
        ...
        .then(data => {
            ...
            data.forEach(articulo => {
                ...
                // Verificar si hay una imagen para el artículo
                if (articulo.imagen) {
                    cardContent += `<img src="${articulo.imagen}" alt="Imagen del artículo" class="article-image"/>`;  // Solo agregar la imagen si existe
                }
